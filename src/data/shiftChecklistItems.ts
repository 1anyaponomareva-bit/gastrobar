...
const GASTROFOOD_EVENING_ITEMS: ShiftChecklistItem[] = [
  ...
  ...[
    ...
    foodEvening(`gf-eve-${id}`, "Открытие смены 17:00–19:00", "Товар и заготовки", label),
  ),
  ...[
    ["eq-1", "Холодильники работают исправно"],
    ["eq-2", "Морозильники работают исправно"],
    ...
    foodEvening(`gf-eve-${id}`, "Открытие смены 17:00–19:00", "Оборудование", label),
  ),
  ...[
    ["out-1", "Убрать территорию вокруг трака"],
    ["out-2", "Вынести весь мусор"],
    ...
    foodEvening(`gf-eve-${id}`, "Открытие смены 17:00–19:00", "Уборка снаружи", label),
  ),
  ...[
    ["in-0", "Посудомоечная машина разобрана"],
    ["in-1", "Очищены рабочие поверхности"],
    ...
    foodEvening(`gf-eve-${id}`, "Открытие смены 17:00–19:00", "Уборка внутри", label),
  ),
  ...
  ...[
    ...
    foodEvening(`gf-eve-${id}`, "Закрытие смены с 03:00 до 04:00", "Остатки и заказ", label),
  ),
  ...[
    ["close-in-1", "Очищены рабочие поверхности"],
    ["close-in-2", "Вымыт инвентарь"],
    ...
    foodEvening(`gf-eve-${id}`, "Закрытие смены с 03:00 до 04:00", "Уборка внутри", label),
  ),
  ...[
    ["close-out-1", "Протерты наружные поверхности"],
    ["close-out-2", "Убрана территория вокруг трака"],
    ...
    foodEvening(`gf-eve-${id}`, "Закрытие смены с 03:00 до 04:00", "Уборка снаружи", label),
  ),
  ...[
    ["close-trash-1", "Весь мусор вынесен"],
    ["close-trash-2", "Установлен новый мусорный пакет"],
  ].map(([id, label]) =>
    foodEvening(`gf-eve-${id}`, "Закрытие смены с 03:00 до 04:00", "Мусор", label),
  ),
  ...[
    ["close-end-1", "Касса посчитана"],
    [
    ...
    foodEvening(`gf-eve-${id}`, "Закрытие смены с 03:00 до 04:00", "Закрытие", label),
  ),
];
