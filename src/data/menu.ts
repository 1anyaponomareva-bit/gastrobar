...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    id: "applekivi",
    name: "Яблоко · Киви",
    description: "Зелёная свежесть киви и сочное яблоко — лёгкий и освежающий дуэт.",
    image: "/menu/apple-kiwi.jpg",
    imageList: "/menu/apple-kiwi.jpg",
    category: "cocktail",
    price: "60000",
    grammage: "50 мл",
    barSubcategory: "tincture",
  ...
  },
  {
    id: "dragonfrukt",
    name: "Драгонфрут",
    description: "Экзотический питайя — мягкая сладость и яркий цвет.",
    image: "/menu/dragonfruit.jpg",
    imageList: "/menu/dragonfruit.jpg",
    category: "cocktail",
    price: "60000",
    grammage: "50 мл",
    barSubcategory: "tincture",
    abv: "28%",
    taste: "питайя, тропики",
    strength: "medium",
  },
  {
    id: "lichi",
    name: "Личи",
    description: "Нежный и ароматный личи — цветочная сладость Азии.",
    image: "/menu/lychee.jpg",
    imageList: "/menu/lychee.jpg",
    category: "cocktail",
    price: "60000",
    grammage: "50 мл",
    barSubcategory: "tincture",
  ...
  {
    id: "olmeca-blanco-tequila",
    name: "Текила Olmeca Blanco",
    description: "Шот.",
    image: "/menu/olmecablanco.png",
    imageList: "/menu/olmecablanco.png",
    category: "cocktail",
    price: "90000",
    grammage: "50 мл",
    barSubcategory: "spirits",
  ...
  {
    id: "olmeca-gold-tequila",
    name: "Текила Olmeca Gold",
    description: "Шот.",
    image: "/menu/olmecagold.png",
    imageList: "/menu/olmecagold.png",
    category: "cocktail",
    price: "130000",
    grammage: "50 мл",
    barSubcategory: "spirits",
  ...
  // Безалкогольные: лимонады → банки → вода
  {
    id: "lemonade-melon-papaya",
    name: "Лимонад Дыня · Папайя",
    description: "Домашний лимонад с дыней и папайей.",
    image: "/menu/MELONPAPAYA.jpg",
    imageList: "/menu/MELONPAPAYA.jpg",
    category: "cocktail",
    price: "50000",
    grammage: "350 мл",
    barSubcategory: "soft",
    taste: "дыня, папайя, свежесть",
  },
  {
    id: "lemonade-blueberry",
    name: "Лимонад Черника",
    description: "Домашний лимонад с черникой.",
    image: "/menu/BLUBERRY.jpg",
    imageList: "/menu/BLUBERRY.jpg",
    category: "cocktail",
    price: "50000",
    grammage: "350 мл",
    barSubcategory: "soft",
  ...
  {
    id: "lemonade-mango-passionfruit",
    name: "Лимонад Манго · Маракуйя",
    description: "Домашний лимонад с манго и маракуйей.",
    image: "/menu/MANGOLEMONADE.jpg",
    imageList: "/menu/MANGOLEMONADE.jpg",
    category: "cocktail",
    price: "50000",
    grammage: "350 мл",
    barSubcategory: "soft",
    taste: "манго, маракуйя, тропики",
  },
  {
    id: "lemonade-passionfruit-mint",
    name: "Лимонад Маракуйя · Мята",
    description: "Домашний лимонад с маракуйей и мятой.",
    image: "/menu/MINT.jpg",
    imageList: "/menu/MINT.jpg",
    category: "cocktail",
    price: "50000",
    grammage: "350 мл",
    barSubcategory: "soft",
    taste: "маракуйя, мята, свежесть",
  },
  {
    id: "coca-cola-can",
    name: "Coca-Cola",
