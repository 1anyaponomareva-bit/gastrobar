  ...
  return (
    ...
    >
      <Link href={href} className="group block w-full outline-none" prefetch>
        <div
          className={cn(
            "games-pick-card games-pick-card--interactive outline-none transition-shadow duration-300",
            variant === "durak" && "games-pick-card--durak",
            variant === "poker" && "games-pick-card--poker",
            "border border-white/[0.08] shadow-[0_18px_48px_-12px_rgba(0,0,0,0.75)]",
        ...
        >
          <div className="games-pick-card__content">
            <div className="games-pick-card__text">
              ...
              <p className="mt-1 text-[11px] font-medium uppercase tracking-[0.12em] text-emerald-300/75">
                {detail}
              </p>
            </div>
...
function GameTableCardSoon({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "games-pick-card games-pick-card--soon relative",
          variant === "durak" && "games-pick-card--durak",
          variant === "poker" && "games-pick-card--poker",
          "border border-white/[0.06] shadow-[0_12px_36px_-16px_rgba(0,0,0,0.8)]"
        )}
        aria-disabled
      >
        <span
