...
export function PosterTestMenuChoiceScreen() {
  ...
  return (
    <main className="poster-test-menu-choice relative mx-auto flex min-h-[100dvh] w-full max-w-md flex-col px-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
      <div
      ...
      <div className="poster-test-menu-choice__content relative z-10">
        <motion.div
