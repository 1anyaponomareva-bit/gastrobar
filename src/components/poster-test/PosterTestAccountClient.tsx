  ...
  return (
    <div className="mx-auto max-w-md px-4 pb-28 pt-6 text-white">
      ...
      <section className="rounded-[24px] border border-white/10 bg-white/[0.05] p-5">
        ...
        <dl className="mt-6 space-y-3 text-sm">
          ...
          <div className="flex justify-between gap-4">
            ...
            <dd className="text-right uppercase text-white/90">{user.provider}</dd>
          </div>
          <div className="flex justify-between gap-4">
            <dt className="text-white/45">Role</dt>
            <dd className="text-right uppercase text-white/90">{user.role}</dd>
          </div>
          <div className="flex justify-between gap-4">
            <dt className="text-white/45">QR slug</dt>
            <dd className="break-all text-right font-mono text-xs text-amber-200/90">{user.qrSlug}</dd>
          </div>
        </dl>
      </section>
      ...
      <button
        ...
        className="mt-4 w-full rounded-2xl border border-white/15 px-5 py-3 text-sm text-white/75"
      >
        Выйти
      </button>
    </div>
