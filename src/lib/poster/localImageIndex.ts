...
const FOOD_LOCAL_ENTRIES: Array<{ name: string; image: string }> = [
  ...
  { name: "Чизбургер Комбо", image: "/food/menu/combo_burger.png?v=20260726-01" },
  ...
  { name: "Пита Кебаб Комбо", image: "/food/menu/pita_combo.png?v=20260726-01" },
  { name: "PITA KEBAB COMBO", image: "/food/menu/pita_combo.png?v=20260726-01" },
  ...
  { name: "Куриный шашлык", image: "/food/menu/grab/chicken-kebab.png" },
  { name: "Бокс с куриным шашлыком", image: "/food/menu/grab/chicken-kebab.png" },
  { name: "CHICKEN KEBAB", image: "/food/menu/grab/chicken-kebab.png" },
  { name: "Свиной шашлык", image: "/food/menu/grab/pork-kebab.png" },
  { name: "Бокс со свиным шашлыком", image: "/food/menu/grab/pork-kebab.png" },
  { name: "PORK KEBAB", image: "/food/menu/grab/pork-kebab.png" },
