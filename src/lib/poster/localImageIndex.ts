...
const FOOD_LOCAL_ENTRIES: Array<{ name: string; image: string }> = [
  ...
  { name: "Куриный суп", image: "/food/menu/Creamy%20Chicken%20Soup.png?v=20260722-01" },
  { name: "CREAMY CHICKEN SOUP", image: "/food/menu/Creamy%20Chicken%20Soup.png?v=20260722-01" },
  ...
  { name: "Куриный шашлык", image: "/food/menu/chickenkebab.jpeg" },
