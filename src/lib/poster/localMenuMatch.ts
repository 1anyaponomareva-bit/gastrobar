...
const FOOD_POSTER_ALIASES: Array<[string, string]> = [
  ...
  ["COMBO CHEESEBURGER", "burger-combo"],
  ["CHEESEBURGER COMBO MEAL", "burger-combo"],
  ["COMBO HOT DOG", "hot-dog-combo"],
  ["HOT DOG COMBO MEAL", "hot-dog-combo"],
  ["COMBO PITA", "pita-kebab-combo"],
  ["COMBO PITA KEBAB", "pita-kebab-combo"],
  ["KEBAB PITA COMBO", "pita-kebab-combo"],
  ...
  ["PORK KEBAB PITA", "kebab-pita"],
  ["PORK PITA", "kebab-pita"],
  ["PITA PORK", "kebab-pita"],
  ["PITA WITH PORK KEBAB", "kebab-pita"],
  ["CHICKEN KEBAB PITA", "kebab-pita"],
  ["CHICKEN PITA", "kebab-pita"],
  ["CHICK PITA", "kebab-pita"],
  ["PITA CHICKEN", "kebab-pita"],
  ["PITA WITH CHICKEN KEBAB", "kebab-pita"],
  ["KEBAB PITA", "kebab-pita"],
  ["PITA KEBAB", "kebab-pita"],
  ["PITA WITH KEBAB", "kebab-pita"],
];
