...
const DESCS_RU: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "Пшеничное пиво: мягкое, с лёгкой фруктовой нотой и сливочным телом.",
  "fuzzy-lemon-cider": "Освежающий лимонный сидр с яркой кислинкой и лёгкой сладостью.",
...
const TASTE_RU: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "пшеничное, мягкое",
  "fuzzy-lemon-cider": "лимон, сидр",
...
const DESCS_EN: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "Soft wheat beer with a light fruit note and creamy body.",
  "fuzzy-lemon-cider": "Refreshing lemon cider with bright acidity and gentle sweetness.",
  ...
  "bacardi-rum": "Single 50 ml pour at the bar.",
  ...
  "olmeca-blanco-tequila": "Single 50 ml pour at the bar.",
  "olmeca-gold-tequila": "Single 50 ml pour at the bar.",
  ...
  "mirinda-can": "Chilled can from the fridge.",
  ...
  "lemonade-melon-papaya": "House lemonade with melon and papaya.",
  "lemonade-blueberry": "House lemonade with blueberry.",
  "lemonade-mango-passionfruit": "House lemonade with mango and passion fruit.",
  "lemonade-passionfruit-mint": "House lemonade with passion fruit and mint.",
...
const DESCS_VN: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "Bia lúa mì mềm, gợi trái cây, thân sữa.",
  "fuzzy-lemon-cider": "Cider chanh mát, chua sáng, ngọt nhẹ.",
  ...
  "bacardi-rum": "Một phần 50 ml tại quầy bar.",
  ...
  "olmeca-blanco-tequila": "Một phần 50 ml tại quầy bar.",
  "olmeca-gold-tequila": "Một phần 50 ml tại quầy bar.",
  ...
  "lemonade-melon-papaya": "Nước chanh nhà làm với dưa lưới và đu đủ.",
  "lemonade-blueberry": "Nước chanh nhà làm với việt quất.",
  "lemonade-mango-passionfruit": "Nước chanh nhà làm với xoài và chanh dây.",
  "lemonade-passionfruit-mint": "Nước chanh nhà làm với chanh dây và bạc hà.",
...
const TASTE_EN: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "Wheat, soft",
  "fuzzy-lemon-cider": "Lemon, cider",
  "fuzzy-lager": "Malt, light",
  "lemonade-melon-papaya": "Melon, papaya, fresh",
  "lemonade-blueberry": "Blueberry, berry",
  "lemonade-mango-passionfruit": "Mango, passion fruit, tropical",
  "lemonade-passionfruit-mint": "Passion fruit, mint, fresh",
...
const TASTE_VN: Record<string, string> = {
  ...
  "fuzzy-wheat-beer": "Lúa mì, mềm",
  "fuzzy-lemon-cider": "Chanh, cider",
  "fuzzy-lager": "Mạch nha, nhẹ",
  "lemonade-melon-papaya": "Dưa lưới, đu đủ, mát",
  "lemonade-blueberry": "Việt quất, mọng",
  "lemonade-mango-passionfruit": "Xoài, chanh dây, nhiệt đới",
  "lemonade-passionfruit-mint": "Chanh dây, bạc hà, mát",
