...
/** Клип растра внутри CardSprite: .table-card → .durak-card-media.card-inner → img */
export const DURAK_CARD_MEDIA_CLASS = "durak-card-media durak-card-inner card-inner";
