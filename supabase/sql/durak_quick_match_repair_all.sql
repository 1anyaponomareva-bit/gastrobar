...
--    не попадает к первому и создаётся вторая комната.
-- 2) durak_finalize_room_if_ready — соло после дедлайна с ботом даже при «кривом» cnt.
-- 3) durak_force_start_if_two_humans + триггер на INSERT room_players.
