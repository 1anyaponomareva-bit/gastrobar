-- Быстрая очередь: после search_deadline один живой должен начать игру с ботом.
-- Раньше было «humans = 1 AND cnt = 1» — при любом другом cnt (застрявшие строки, гонка)
-- финализация не вызывала старт, экран «ищем соперника» мог висеть бесконечно.
