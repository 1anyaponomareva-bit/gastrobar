-- Быстрая очередь: при двух игроках за столом сразу переводим в playing.
-- Раньше ждали либо max_players=3, либо истечения search_deadline — два человека сидели минутами в «поиске».
